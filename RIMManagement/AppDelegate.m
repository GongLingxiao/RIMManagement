...
- (void)customizeAppearance
{
    ...
    UIImage *buttonBack = [UIImage imageNamed:@"trip_bar_back"];
    ...
    UIImage *tabBackground = [[UIImage imageNamed:@"tabbar_background"] resizableImageWithCapInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
    [[UITabBarItem appearance] setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:
                                                       [UIColor colorWithRed:137.0/255.0 green:146.0/255.0 blue:168.0/255.0 alpha:1.0], UITextAttributeTextColor,
                                                       nil] forState:UIControlStateNormal];
    UIColor *titleHighlightedColor = [UIColor colorWithRed:235.0/255.0 green:81.0/255.0 blue:17.0/255.0 alpha:1.0];
    [[UITabBarItem appearance] setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:
    ...
    [[UITabBar appearance] setSelectionIndicatorImage:[UIImage imageNamed:@"tabbar_item_selected"]];
}
